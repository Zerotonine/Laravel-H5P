<div class="flex flex-col justify-center">
    ...
    @if($contentId)
        ...
        <iframe id="h5p-iframe-{{$contentId}}" src="http://localhost:8000/admin/h5p/h5p/embed/{{$contentId}}{{$bundleId ? '/'.$bundleId : ''}}" width="{{$width}}" height="{{$height}}" frameborder="0" allowfullscreen>
        </iframe>
